...
if __name__ == '__main__':
    ...
    if debug:
        database = pd.read_csv(os.path.join(final_condition_data_path, database_fname), nrows=10000)
        final_condition_data_path = os.path.join(source_data_path, 'USPTO_condition_final_debug')
