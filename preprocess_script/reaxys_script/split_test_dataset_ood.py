...
if __name__ == '__main__':
    ...
    final_condition_data_path = os.path.join(
        source_data_path, 'Reaxys_total_syn_condition_final_balance')
    database_fname = 'Reaxys_total_syn_condition_test_for_ood.csv'
    ...
    proprecess_baseline_dataset(have_catalyst_test_datset, final_condition_data_path=final_condition_data_path, database_fname='Reaxys_total_syn_condition_test_for_ood_have_catalyst.csv')
    ...
    proprecess_baseline_dataset(catalyst_na_test_datset, final_condition_data_path=final_condition_data_path, database_fname='Reaxys_total_syn_condition_test_for_ood_catalyst_na.csv')
